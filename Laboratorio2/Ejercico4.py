...
n=input("ingrese el numero(4,5,6 u 8) de lados del poligono:")
def funcion(n):
    n=n
    if n==4:
        ...
        plt.show()
         ...
         hexagono=[[4,8,2,4,8,10],[1,1,4.46,7.93,4.46]]
         plt.plot(hexagono)
         plt.plot(hexagono[0],hexagono[1])
         plt.show()
     elif n==8;
          octagono=[[4,7,1.88,1.88,4,7,9.12,9.12],[1,1,3.12,6.12,8.24,8.24,6.12,3.12]]
          plt.plot(octagono)
          plt.(octagono[0],octagono[1])
          plt.show()
